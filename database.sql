...
('name','Name','somname','spanname','homname'),
('yes','Yes','somyes','spanyes','hyes'),
('no','No','somno','spanno','hno'),
('military_active','Yes - Active','somactive','spanact','hact'),
('military_veteran','Yes - Veteran','somvet','spanvet','hvet'),
('enter_number','Enter number here.','somnum','spannum','hnum'),
('remove_household_member','Remove this household memeber','somremove','spanremove','move'),
('date_of_birth','Date of Birth','somdate','spandate','hdate'),
('race_check_all','Race (check all that apply)','sorace','sprace','hrace'),
('race_white','White','sowhite','spwhite','hwhite'),
('race_black','Black','soblack','spblack','hblack'),
('race_islander','Native Hawaiian or other Pacific Islander','soisland','spisland','land'),
('race_asian','Asian','soasian','spasian','hasian'),
('race_native','American Indian or Alaskan Native','sonative','spnative','hnative'),
