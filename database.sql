...
('thanks', 'Thank you! Visit your site manager the week of July 8 to get your $10.', '¡Gracias! Visite al administrador de su edificio durante la semana del 8 de julio para recibir sus $10.', 'Mahadsanid! Xafiiska maamulaha dhismaha imow si aad uga qaadato lacagta $10', 'Ua tsaug! Mus ntsib koj tus nai saib lub chaw rau lub asthiv ntawm Lub Xya Hli Tim 8 yog koj xav tau koj qhov nyiaj $10.', 'Galatoomaa! $10 keessan argachuuf Toban Adoolessa 8ii  keessa hoogganaa bakka keessan jiru quunnama`a.'),
('requestresults', 'Summarized results of this confidential survey will be available from Aeon after September 1, upon your request. To request results, call us at 612-746-0520.', 'Los resultados resumidos de este formulario confidencial estarán disponible a partir de Aeon con una petición. Para solicitar los resultados llámenos al 612-746-0520.', 'Natiijada la soo koobay ee ra''yi-ururintan asturnaanta kalsoonida leh ayaa laga heli doonaa Aeon marka alaga codsato. Si aad u codsato natiijada, naga soo wac 612-746-0520.', 'Cov lus uas nej sawv daws teb rau cov lus nug no Aeon yuav muab sau kom tiav log rau hnub 9/1/2019 no.  Yog nej leej twg xav tau ib daim no ces hu tau rau 612 - 746 - 0520.', 'Summarized results of this confidential survey will be available from Aeon after September 1, upon your request. To request results, call us at 612-746-0520.'),
...
('survey', 'Home Survey', 'Encuesta de casa', 'Su’aalo Qoran oo ku Saabsan Guriga', 'Lus Nug Txog Tsev', 'Home Survey'),
...
('logout', 'Logout', 'Cerrar la session','Ka Bax','Tua Tawm Mus', 'Logout'),
('writeanswer', 'Write your answer here.', 'Escriba su respuesta aquí.','Halkan ku qor jawaabtaada.','Sau koj lo lus teb rau ntawm no.', 'Write your answer here.'),
('surecancel', 'Are you sure you want to cancel? This cannot be undone.', '¿Está seguro de que quiere cancelar? No podrá recuperar la información.','Ma iska hubtaa in aad joojiso? Arrintan kama noqon kartid.', 'Koj puas xav muab tso tseg tiag? Qhov no rov thim ua dua tsis tau lawm.', 'Are you sure you want to cancel? This cannot be undone.'),
('suresubmit', 'Are you sure you want to submit?', '¿Está seguro de que quiere completar y enviar? Ya no podrá regresar.','Ma iska hubtaa in aad rabto inaad dirto? Arrintan kama noqon kartid.', 'Koj puas xav muab xa mus tiag? Qhov no rov thim ua dua tsis tau lawm.', 'Are you sure you want to submit?'),
...
('add_household_member', 'Add another household member', 'Añadir otro nombre de la casa', 'Ku dar xubnaha kale ee qoyska', 'Add another household member', 'Add another household member'),
...
('remove_household_member','Remove this household member','Eliminar este miembro de la casa','Ka saar xubintan aqalka','Remove this household member','Remove this household member'),
